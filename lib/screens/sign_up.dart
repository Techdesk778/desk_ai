          ...
          child: Card(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Text("Create Account", style: GoogleFonts.lato(fontSize: 28, fontWeight: FontWeight.bold, color: const Color(0xFF001F3F))),
                  const SizedBox(height: 20),
                  TextField(decoration: InputDecoration(labelText: "Full Name", labelStyle: GoogleFonts.lato())),
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: Text("Register", style: GoogleFonts.lato(color: Colors.white, fontSize: 16)),
                    ),
                  ),
                ],
              ),
